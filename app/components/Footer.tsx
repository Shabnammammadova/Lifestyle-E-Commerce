...
//     <div className='flex mt-20 w-full mx-auto justify-between font-serif text-black text-xl px-8'>
// <ul>
  ...
  return (
    <div>
      <div className='flex items-center pt-20 bg-orange-50 flex-col'>
        ...
        <div className='flex items-center mt-20 w-full mx-auto justify-between font-serif text-black text-xl px-8 flex-col md:flex-row'>
          ...
          <ul className='flex flex-col'>
            <p className='mb-8'>Legal</p>
            <li className='hover:underline hidden md:block'>Terms & Conditions</li>
