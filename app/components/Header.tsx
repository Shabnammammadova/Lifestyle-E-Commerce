    ...
    <div className="fixed z-50 w-full bg-[#F3E6DA]">
      <div className="flex items-center justify-between px-4 lg:px-10 py-6 max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center gap-5">
          ...
          <Dialog>
            ...
            <div className="flex">
              <DialogContent className="sm:max-w-[400px] min-h-screen bg-[#F3E6DA] fixed left-[87%]">
                ...
                <DialogDescription>
                  incl. 20% VAT. excl. Shipping costs: 11.80€
                </DialogDescription>
                <hr />
          ...
          <MenuIcon onClick={toggleMobileMenu} className="xl:hidden cursor-pointer" />
        </div>
      </div>


      {isMobileMenuOpen && (
        <div className="xl:hidden bg-[#F3E6DA]">
          <div className="flex flex-col gap-4 items-center pt-4">
            <Link href="/shop" className={pathname === "/shop" ? "underline" : "text-black"}>
              Shop
            </Link>
            <Link href="/sunglasses" className={pathname === "/sunglasses" ? "underline" : "text-black"}>
              Sunglasses
            </Link>
            <Link href="/bag" className={pathname === "/bag" ? "underline" : "text-black"}>
              Bag
            </Link>
            <Link href="/blazer" className={pathname === "/blazer" ? "underline" : "text-black"}>
              Blazer
            </Link>
            <Link href="/shoes" className={pathname === "/shoes" ? "underline" : "text-black"}>
              Shoes
            </Link>
          </div>
        </div>
