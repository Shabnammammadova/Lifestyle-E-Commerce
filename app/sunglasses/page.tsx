      ...
      <div className="flex flex-col items-center gap-20  xl:flex-row xl:items-center xl:justify-center xl:gap-60 mt-20 mb-20 ">
        <div className="pl-10 pr-10 flex flex-col gap-5">
          ...
          <p>
           ...
           <br /> occasion be, these unique luxury designs are <br />  going to stand
            out.
          </p>
          <Button
        ...
        <div className="max-w-sm ">
          <Image src="	https://lifestyle-eta.vercel.app/images/gogals-product-1.png" alt="sunglasses" width={200} height={300}/>
...
<section>
  <h1 className="text-5xl font-bold font-serif text-center mt-40 mb-40">Glasses <br />
  Mix & Match</h1>
</section>
...
<section id="Projects"
    ...
    <div className=" w-full lg:w-[500px] bg-[#F3E6DA] flex flex-col items-center gap-10">
            <Image src="https://lifestyle-eta.vercel.app/images/gogals-product-7.png"
                    alt="Product" className="duration-500 hover:scale-105 relative top-20 " width={320} height={350}/>
            <div className="w-[300px] lg:w-[450px]">
                <div className="flex items-center w-full justify-between gap-10 relative mt-10">
                    <p className="text-lg font-semibold text-black cursor-auto my-3">White framed glasses</p>
                    <div className="ml-auto"><p>$49,00</p></div>
                </div>
            </div>
    </div>
    <div className="w-full lg:w-[500px] bg-[#F3E6DA] flex flex-col items-center gap-20">
            <Image src="https://lifestyle-eta.vercel.app/images/gogals-product-8.png"
                    alt="Product" className="duration-500 hover:scale-105 relative top-20 " width={320} height={350}/>
            <div className="w-[300px] lg:w-[450px]">
                <div className="flex items-center w-full justify-between gap-10 relative mt-10">
                    <p className="text-lg font-semibold text-black cursor-auto my-3">Cat Eye One</p>
                    <div className="ml-auto"><p>$49,00</p></div>
                </div>
            </div>
    </div>
    <div className="w-full lg:w-[500px]  bg-[#F3E6DA] flex flex-col items-center gap-20">
            <Image src="https://lifestyle-eta.vercel.app/images/gogals-product-9.png"
                    alt="Product" className="duration-500 hover:scale-105 relative top-20 " width={320} height={350}/>
            <div className="w-[300px] lg:w-[450px]">
                <div className="flex items-center w-full justify-between gap-10 relative mt-10">
                    <p className="text-lg font-semibold text-black cursor-auto my-3">Maroon glasses</p>
                    <div className="ml-auto"><p>$49,00</p></div>
                </div>
            </div>
    </div>
...
<h1 className="uppercase text-white text-7xl font-serif m-0">Be inspired <span className="text-4xl block">@lifestyle</span></h1>
</div>
<section id="Projects"
    ...
    <div className="w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
            <Image src="https://lifestyle-eta.vercel.app/images/instagram-1.jpg"
                    alt="Product" className="h-80 w-72 object-cover" width={300} height={300}/>
    </div>
    <div className="w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
            <Image src="https://lifestyle-eta.vercel.app/images/instagram-2.jpg"
                    alt="Product" className="h-80 w-72 object-cover" width={300} height={300}/>
    </div>
    <div className="w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
            <Image src="https://lifestyle-eta.vercel.app/images/instagram-3.jpg"
                    alt="Product" className="h-80 w-72 object-cover" width={300} height={300}/>
    </div>
    
</section>
<div className="relative text-right -mt-12 font-serif pr-2 pl-10 lg:pr-48 lg:pl-20 text-white"><h1 className="m-0 text-7xl">Follow Us<span className="text-4xl block">on Instagram</span></h1></div>
</div>

{/* bg-[rgba(72,72,72,0.44)] */}
<section>
  <div className="relative top-0 left-0 w-full h-full" >
    <Image className="object-cover" src="https://lifestyle-eta.vercel.app/images/collection-full-banner-1.jpg" alt="image" width={1520} height={490}/>
  </div>
  {/* <div className="container"><div className="row"><div className="col-12"><div className="relative text-center">
<h2 className="text-center uppercase m-0 text-white"><span className="block">The</span>HautE couture<span>collection</span></h2></div></div></div></div> */}
</section>
