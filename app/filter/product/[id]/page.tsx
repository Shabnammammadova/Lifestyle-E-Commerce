        ...
        <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
                <div className="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 pt-12 pb-10 flex items-center justify-center">
                    <Image className="flex items-center justify-center object-cover" src={product.imageUrl} alt="Product Image" width={300} height={300}/>
                </div>
            ...
            <div className="md:flex-1 px-4">
                ...
                Bring Fashion Week home when you shop designer glasses from Versace, Dolce&Gabbana, Gucci and more.
                For a limited time, get up to <b>50%</b> off lenses on eyeglasses and sunglasses.
                </p>
                ...
                <div className="flex -mx-2 mb-4">
                    ...
                    <div className="w-1/2 px-2">
                        <button className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600">Add to Favorite</button>
                    </div>
                </div>
