      ...
      <section>
        <div className="relative w-full h-full">
          <Image
            ...
            src="https://lifestyle-eta.vercel.app/images/hero-benner-2.jpg"
      ...
      <section>
        <div className="flex flex-col items-center gap-20  xl:flex-row xl:items-center xl:justify-center xl:gap-60 mt-20 mb-20 ">
          <div className="pl-10 pr-10 flex flex-col gap-5">
            ...
            <p>
              bag with Italian designs! Whatever the occasion <br /> be, these
              unique luxury designs are going to <br /> stand out.
            </p>
            <Button
          ...
          <div className="flex flex-col gap-24 items-center  lg:flex-row lg:gap-60 ">
            <div className="max-w-sm ">
              <Image
                src="https://lifestyle-eta.vercel.app/images/bag-product-2.png"
                alt="bag"
                width={200}
                height={300}
              />
            ...
            <div className="max-w-sm ">
              <Image
                src="	https://lifestyle-eta.vercel.app/images/bag-product-3.png"
                alt="bag"
                width={200}
                height={300}
              />
      ...
      <section className="w-full">
        <div className="flex  items-center  lg:flex-row flex-col">
          <div className="flex-shrink-0">
            <Image
              src="https://lifestyle-eta.vercel.app/images/bag-images-1.jpg"
              alt="bag"
              width={1000}
              height={590}
        ...
        <div className="flex  items-center  lg:flex-row flex-col">
          ...
          <div className="flex-shrink-0">
            <Image
              src="https://lifestyle-eta.vercel.app/images/bag-images-2.jpg"
              alt="bag"
              width={1000}
              height={590}
              className="object-cover"
        ...
        <div className="flex  items-center  lg:flex-row flex-col">
          <div className="flex-shrink-0">
            <Image
              src="https://lifestyle-eta.vercel.app/images/bag-images-3.jpg"
              alt="bag"
              width={1000}
              height={590}
              className="object-cover"
      ...
      <div className="bg-[#F3E6DA] w-full pt-32 pb-10 ">
        ...
        >
          <div className="w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
            <Image
              src="https://lifestyle-eta.vercel.app/images/instagram-4.jpg"
              alt="Product"
          ...
          <div className="w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
            <Image
              src="https://lifestyle-eta.vercel.app/images/instagram-5.jpg"
              alt="Product"
              className="h-80 w-72 object-cover"
              width={300}
              height={300}
          ...
          <div className="w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
            <Image
              src="https://lifestyle-eta.vercel.app/images/instagram-6.jpg"
              alt="Product"
              className="h-80 w-72 object-cover"
              width={300}
              height={300}
      ...
      <section>
        <div className="relative w-full h-full">
          <Image
            ...
            src="	https://lifestyle-eta.vercel.app/images/collection-full-banner-2.jpg"
            alt="Haute Couture Collection"
            width={1520}
            height={490}
          />
